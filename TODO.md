P1:
* running car then rila crashes (memory?)
...
* should be function save_pipe(), set_pipe(), restore_pipe() for putch to be able to attach to anything, and syscalls for this (only set pipe needs to be syscall)
